...
class UkfParams:
    ...
    def fromBase(cls, base: "UkfParams", **overrides) -> "UkfParams":
        ...
        constructorAttrs = {
            ...
            "supposedInitialAlpha": base.supposedInitialAlpha,
            "supposedInitialAlphadot": base.supposedInitialAlphadot,
            "supposedInitialBias": base.supposedInitialBias,
            "processAlphaNoiseStd": base.processAlphaNoiseStd,
...
if __name__ == "__main__":
    ...
    paramsRef = UkfParams(simConfig, processBiasNoiseStd=1.0)
